...
ERROR_MESSAGES = {
    ...
    "NOT_ADMIN_ASSIGN_PERIOD": "관리자 지정 가능 시간(목요일 17:00 ~ 일요일 23:59)이 아닙니다.",
    ...
    "HOLIDAY_SLOT": "대한민국 공휴일에는 신청할 수 없습니다.",
...
def raise_app_error(code: str, http_status: Optional[int] = None) -> None:
    status_map = {
        ...
        "NOT_ADMIN_CANCEL_BEFORE_CLOSE": 409,
        "NOT_ADMIN_CANCEL_SLOT_PAST": 409,
        "NOT_ADMIN_CANCEL_REAPPLY": 409,
        "NOT_ADMIN_ASSIGN_PERIOD": 409,
