...
SMTP_HOST=${SMTP_HOST:-maile002.roundcube.mail.iwinv.kr}
SMTP_PORT=${SMTP_PORT:-587}
SMTP_USER=${SMTP_USER:-}
SMTP_PASSWORD=${SMTP_PASSWORD:-}
SMTP_FROM=${SMTP_FROM:-noreply@ibank.co.kr}
